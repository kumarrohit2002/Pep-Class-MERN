...
recipes.forEach((obj, idx) => {
    const { name, image, cuisine, rating, servings, ingredients } = obj;
    const newDiv = document.createElement("div");
    newDiv.className = "card";
    newDiv.innerHTML = `
        <div>
                <h3> ${idx + 1}: ${name}</h3>
                <img src='${image}' width='280' height='200'>                <div>
                    <p>${rating}</p>
                    <p>${cuisine}</p>
                <div/>
                <p>${ingredients}</p>
        ...
        <button onclick='handleCardClick(${JSON.stringify(obj)})'>Click Me</button>
    `;
...
const popContent = document.getElementById('pop-up-container');
const handleCardClick = (obj) => {
    ...
    popContent.innerHTML = `
        ...
        <button onclick="handleClosePopUp()" id="pop-up-close-button">Close</button>
