...
for(let i=0;i<recipes.length;i++){
    ...
    arr.push({name:name,cuisine:cuisine});
}
console.log(arr);
...
const arr1=[];
recipes.forEach((r)=>{
    const {name,cuisine}=r;
    arr1.push({name:name,cuisine:cuisine});
})
console.log(arr1)

// ------------------------using map -----------------------------

const arr2 = recipes.map((r)=>{
                const {name,cuisine}=r;
                return {name,cuisine}; 
            })
...
// ----------------------------Filter (rating>4.5) ----------------
const ans=[];
const arr3 = recipes.filter((r)=>{
                const {rating,name,cuisine}=r;
                if(rating>4.5){
                    ans.push({name,cuisine});
                    return true;
                }else{
                    return false;
                }
